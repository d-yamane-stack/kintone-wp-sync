...
// テーマ: 中古リノベ（物件探し〜購入・リノベーション検討層の検索意図）
// siteConfigs の recommendConfig.focusAreas（中古住宅購入/中古マンション/リノベーション費用/
// 住宅ローン/補助金/物件選び）に沿って設定
const ESTATE_THEMES = [
  '中古住宅 リノベーション',
  '中古住宅 購入',
  '中古マンション リノベーション',
...
// recommendConfig.focusAreas（新築注文住宅/家づくり/間取り/住宅性能/断熱・気密/
// 資金計画/住宅ローン/土地探し/デザイン住宅）に沿って設定
const FUNS_THEMES = [
  '注文住宅',
  '新築 一戸建て',
  '工務店',
